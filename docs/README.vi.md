# Mini DataOps Platform — Hướng dẫn vận hành (tiếng Việt)

> Bản tiếng Anh dành cho người đọc lần đầu: [README.md](../README.md)
...
[docs/postmortems/](postmortems/) ghi lại bốn sự cố thật, mỗi cái theo cùng
...
[docs/chaos-drills.md](chaos-drills.md) ghi 12 kịch bản đã thực sự chạy trên
...
[docs/dr-plan.md](dr-plan.md) nêu RPO, RTO và quy trình cho từng kịch bản, kèm
...
[docs/runbooks/](runbooks/) — người trực bấm thẳng từ Alertmanager là tới.
